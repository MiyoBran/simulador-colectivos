...
public class SimuladorUI {
	...
	public void start() {
		...
		while (!salir) {
			...
			System.out.println("3. Ver estadísticas de la simulación");
			...
			case "3":
				...
				break;
			// case "4":
			// TODO: Característica de rutas aún no implementada correctamente
			/*
			 ...
			 * String idDestino = scanner.nextLine(); Parada origen =
			 * controller.getParadasCargadas().get(idOrigen); Parada destino =
			 * controller.getParadasCargadas().get(idDestino); if (origen == null || destino
			 * == null) { System.out.println("Parada origen o destino no encontrada."); }
			 ...
			 *//*
				 * System.out.
				 * println("La funcionalidad de rutas aún no está implementada correctamente.");
				 * break;
				 */
			case "0":
				salir = true;
